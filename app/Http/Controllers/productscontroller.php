...
class Productscontroller extends Controller
{
    ...
    public function create(Request $request){
        ...
        Products::create([
            ...
            'image' => 'https://jibrailif22a.ylladev.my.id/storage/images/'.$imageName,
            // 'modified_by' => $email, //cara mengisi kolom modified_by
        ]);
    ...
    public function update(Request $request,$id){
                ...
                if($Products){
                    ...
                    $Products->update([
                        ...
                        'category_id' => $category->id, // Gunakan ID kategori yang ditemukan
                        'expired_at' => $validated['expired_at'],
                        'image' => 'https://jibrailif22a.ylladev.my.id/storage/images/'.$imageName?? $Products->image // Jika tidak ada gambar baru, gunakan gambar lama
                    ]);
